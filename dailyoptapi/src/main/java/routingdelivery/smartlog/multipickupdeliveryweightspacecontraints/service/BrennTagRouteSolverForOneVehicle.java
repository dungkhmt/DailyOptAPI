...
import routingdelivery.smartlog.multipickupdeliveryweightspacecontraints.model.Vehicle;
	...
	public String analyzeNotServed(Vehicle vh, int index) {
		...
		if (cannotReachLocationCodes.contains(pickupLocation)
			...
			retDes = "\nXe " + vh.getVehicleCategory()
					+ " khÃ´ng thá»ƒ Ä‘i Ä‘áº¿n Ä‘iá»ƒm Ä‘Ã³n hoáº·c tráº£ hÃ ng "
		...
		if(ec > 0){
			retDes = "\nKhÃ´ng thá»ƒ phá»¥c vá»¥ Ä‘Æ¡n hÃ ng " + solver.getOrderIDAtPoint(pickup) + 
					" do vi pháº¡m khung thá»�i gian lÃ m viá»‡c";
		}
		return retDes;
