...
public class IndividualExportLadenRouteComposer implements RouteComposer {
	private InitGreedyImproveSpecialOperatorSolver solver;
	private Measure ms;
	private TruckRoute route;
	private ExportLadenRequests req;
	private TruckRouteInfo4Request tri;
	private double distance;
	
	public IndividualExportLadenRouteComposer(
			InitGreedyImproveSpecialOperatorSolver solver,
			Measure ms, TruckRoute route,
			ExportLadenRequests req, TruckRouteInfo4Request tri, double distance) {
		super();
		this.solver = solver;
		this.ms = ms;
		this.route = route;
	...
	public String name(){
		return "IndividualExportLadenRouteComposer";
	}
	@Override
