...
public class IndividualEmptyContainerToDepotRouteComposer implements
		RouteComposer {
	private InitGreedyImproveSpecialOperatorSolver solver;
	private TruckRoute route;
	private EmptyContainerToDepotRequest req;
	private TruckRouteInfo4Request tri;
	private double distance;
	
	public String name(){
		return "IndividualEmptyContainerToDepotRouteComposer";
				
	}
	public IndividualEmptyContainerToDepotRouteComposer(
			InitGreedyImproveSpecialOperatorSolver solver, TruckRoute route,
			EmptyContainerToDepotRequest req, TruckRouteInfo4Request tri,
			double distance) {
		super();
		this.solver = solver;
		this.route = route;
