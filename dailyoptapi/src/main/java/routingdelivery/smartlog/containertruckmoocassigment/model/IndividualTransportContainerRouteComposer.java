...
public class IndividualTransportContainerRouteComposer implements RouteComposer {
	private InitGreedyImproveSpecialOperatorSolver solver;
	private TruckRoute route;
	private TransportContainerRequest req;
	private TruckRouteInfo4Request tri;
	private double distance;
	
	public String name(){
		return "IndividualTransportContainerRouteComposer";
	}
	public IndividualTransportContainerRouteComposer(
			InitGreedyImproveSpecialOperatorSolver solver, TruckRoute route,
			TransportContainerRequest req, TruckRouteInfo4Request tri,
			double distance) {
		super();
		this.solver = solver;
		this.route = route;
