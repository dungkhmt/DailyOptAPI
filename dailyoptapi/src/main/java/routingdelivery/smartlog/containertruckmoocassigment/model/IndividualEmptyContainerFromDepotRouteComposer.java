...
public class IndividualEmptyContainerFromDepotRouteComposer implements
		RouteComposer {
	private InitGreedyImproveSpecialOperatorSolver solver;
	private TruckRoute route;
	private EmptyContainerFromDepotRequest req;
	private TruckRouteInfo4Request tri;
	private double distance;
	
	
	public IndividualEmptyContainerFromDepotRouteComposer(
			InitGreedyImproveSpecialOperatorSolver solver, TruckRoute route,
			EmptyContainerFromDepotRequest req, TruckRouteInfo4Request tri,
			double distance) {
		super();
		this.solver = solver;
		this.route = route;
	...
	public String name(){
		return "IndividualEmptyContainerFromDepotRouteComposer";
	}
	@Override
